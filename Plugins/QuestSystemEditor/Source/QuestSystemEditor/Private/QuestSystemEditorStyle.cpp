...
TSharedPtr< FSlateStyleSet > FQuestSystemEditorStyle::StyleInstance = NULL;

void FQuestSystemEditorStyle::Initialize()
{
...
void FQuestSystemEditorStyle::Shutdown()
{
...
FName FQuestSystemEditorStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("QuestSystemEditorStyle"));
	return StyleSetName;
}
...
void FQuestSystemEditorStyle::ReloadTextures()
{
...
const ISlateStyle& FQuestSystemEditorStyle::Get()
{
